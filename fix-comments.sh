...
# Ajout de la modification et suppression des commentaires

echo "📝 Mise à jour avec édition et suppression des commentaires..."
...
export default function ReviewPage() {
  ...
  // État pour l'édition de commentaires
...
echo "  - Modifier un commentaire"
echo "  - Supprimer un commentaire"
echo "  - Changer de nom avant d'envoyer"
