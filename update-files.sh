...
# Script de mise à jour - Corrections
# À exécuter depuis le dossier ethos-review

echo "📝 Mise à jour de app/review/[token]/page.tsx..."
...
echo "📝 Mise à jour de app/admin/project/[id]/page.tsx..."
...
echo "  1. Images en 100% de largeur (desktop)"
echo "  2. Bug commentaires corrigé (stopPropagation)"
echo "  3. Icônes supprimées, tablette retirée"
echo ""
echo "Rafraîchis ta page pour voir les changements."
